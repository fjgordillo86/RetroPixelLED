...
//                          CONSTANTES & FIRMWARE
// ====================================================================
#define FIRMWARE_VERSION "3.0.5" // MODIFICADO: HotFix guardado de ajustes en la pagina de configuración y enModoGestion = false cuando salimos de File Managier
