...
//                          CONSTANTES & FIRMWARE
// ====================================================================
#define FIRMWARE_VERSION "3.0.1" // MODIFICADO: Nueva versión del firmware que implemeta listado de GIFs sin limite listanod directamente en la SD sin pasar por RAM.
