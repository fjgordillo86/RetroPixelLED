...
//                          CONSTANTES & FIRMWARE
// ====================================================================
#define FIRMWARE_VERSION "2.2.9" // MODIFICADO: Nueva versión del firmware
...
void dibujarBarraNotificaciones() {
    ...
    display->drawBitmap(offset + 99, 0, iconToDraw, 8, 8, colorClima);

    // 4. Dibujar Temperatura
    display->setTextColor(display->color565(200, 200, 200));
    display->setCursor(offset + 110, 0); 
    display->print(mqtt_temp);
    if(mqtt_temp != "--") {
        // Dibujamos un pequeño cuadrado de 2x2 para el grado
        display->drawRect(offset + 117, 0, 2, 2, display->color565(200, 200, 200));
        display->setCursor(offset + 120, 0);
        display->print("C");
    }
